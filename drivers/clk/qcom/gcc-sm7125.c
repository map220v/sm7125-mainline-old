...
#include <dt-bindings/clock/qcom,gcc-sm7125.h>
...
static struct gdsc *gcc_sm7125_gdscs[] = {
...
static struct clk_hw *gcc_sm7125_hws[] = {
	[GCC_GPLL0_MAIN_DIV_CDIV] = &gcc_pll0_main_div_cdiv.hw,
};

static struct clk_regmap *gcc_sm7125_clocks[] = {
    ...
    //idk why, but this causes system(or display?) to freeze. (I uncomment this after fix)
...
static const struct qcom_reset_map gcc_sm7125_resets[] = {
...
static const struct regmap_config gcc_sm7125_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_sm7125_desc = {
	.config = &gcc_sm7125_regmap_config,
	.clk_hws = gcc_sm7125_hws,
	.num_clk_hws = ARRAY_SIZE(gcc_sm7125_hws),
	.clks = gcc_sm7125_clocks,
	.num_clks = ARRAY_SIZE(gcc_sm7125_clocks),
	.resets = gcc_sm7125_resets,
	.num_resets = ARRAY_SIZE(gcc_sm7125_resets),
	.gdscs = gcc_sm7125_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_sm7125_gdscs),
};

static const struct of_device_id gcc_sm7125_match_table[] = {
	{ .compatible = "qcom,gcc-sm7125" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_sm7125_match_table);

static int gcc_sm7125_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_sm7125_desc);
	if (IS_ERR(regmap))
	...
	return qcom_cc_really_probe(pdev, &gcc_sm7125_desc, regmap);
}

static struct platform_driver gcc_sm7125_driver = {
	.probe = gcc_sm7125_probe,
	.driver = {
		.name = "gcc-sm7125",
		.of_match_table = gcc_sm7125_match_table,
	},
};

static int __init gcc_sm7125_init(void)
{
	return platform_driver_register(&gcc_sm7125_driver);
}
core_initcall(gcc_sm7125_init);

static void __exit gcc_sm7125_exit(void)
{
	platform_driver_unregister(&gcc_sm7125_driver);
}
module_exit(gcc_sm7125_exit);

MODULE_DESCRIPTION("QTI GCC SM7125 Driver");
